...
<header style = "padding: 1%" class="w3-border-bottom w3-border-black theme w3-container fix width">
	...
	<font face = "SqueakyChalkSound" size = "5" color = "white"> &nbsp; 	U share </font>
	...
	<div class="w3-row">
	  ...
	  <div class="w3-container w3-col" style="width:50%">	
		...
		<div style = "margin-top: -1.5%" class="w3-container w3-section w3-pale-red w3-round w3-border">
			...
			<div> 
				<a href = "#"> <img class = "postMargin left" src="<?php echo base_url();?>img/agree.png" alt="Smiley face" height="20" width="20"> <font class = "postMargin left" style = "margin-right: 10px;" size = "2" >Agree </font></a> 
				<a href = "#"> <img style = "margin: 0% 0% -5% 0%" class = "postMargin left" src="<?php echo base_url();?>img/disagree.png" alt="Smiley face" height="20" width="20"> <font class = "postMargin left" style = "margin-left: 20px;"size = "2" >Disagree </font> </a>
