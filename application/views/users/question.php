...
<div  class="w3-row">
	...
	<div class="w3-twothird">
		...
		<div id="container" style="margin-top:205px">
			 ...
			 <h1>
			 	<font color = "black" face = "Century Gothic"> <?php echo $detail->$email; ?>  &nbsp; </font>
			 </h1>
			...
			<div id="body">
				...
				<form method = "POST" action ="">
					<font face = "Calibri" color = "black" size = "3">
						  ...
						  <input class="form-control" type="text" name = "forgot_question" placeholder="Forgot Password Question is : "	 value="<?php echo $detail->$forgot_question; ?>" required disabled>
						</div>
						
						
						<div class="input-group" style = "margin-bottom: 5px;">
						  <span class="input-group-addon"><i class="fa fa-reply fa-fw"></i></span>
						  <input class="form-control" type="text" name = "forgot_password" placeholder="Answer" required>
						</div>
						<?php echo form_error('forgot_password'); ?>

			<a href="reset"><input style = "margin-bottom: 15px;" type = "Submit" value = "Submit"/></a>
					</font>
				</form>
